...
Topic.create(number: 1, title: 'Basics', lecture_id: 1)
Topic.create(number: 2, title: 'Strings', lecture_id: 1)
Topic.create(number: 3, title: 'Number', lecture_id: 1)
Topic.create(number: 4, title: 'Flow Control', lecture_id: 1)
Topic.create(number: 5, title: 'Loops', lecture_id: 1)
Topic.create(number: 6, title: 'Arrays', lecture_id: 1)
Topic.create(number: 7, title: 'Hashes', lecture_id: 1)
Topic.create(number: 8, title: 'Exceptions', lecture_id: 1)
Topic.create(number: 9, title: 'OOP', lecture_id: 1)
Topic.create(number: 10, title: 'Modules & Mixins', lecture_id: 1)
